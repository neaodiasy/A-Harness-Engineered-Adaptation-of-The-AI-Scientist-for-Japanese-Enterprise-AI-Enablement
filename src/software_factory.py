...
def build_file_manifest(product_spec: dict) -> dict:
    ...
    files = [
        ...
        ("generated_layout_config.json", "Build-time generated frontend layout, primitive composition, and visual experience configuration."),
        ...
        ("frontend/generated_layout_config.json", "Build-time generated frontend layout and UI primitive composition consumed by the frontend."),
